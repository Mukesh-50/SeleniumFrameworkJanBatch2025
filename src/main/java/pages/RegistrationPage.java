...
public class RegistrationPage {
	...
	public boolean registerNewUser(String username,String emailid, String userPass, String stateSelection, String hobbiesSelection)
	{
		...
		Utility.clickElement(driver, gender);
